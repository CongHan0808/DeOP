...
def register_all_coco_stuff_164k(root):
    ...
    image_dir = os.path.join(root, "val2017_head20")
    gt_dir = os.path.join(root, "val2017_head20_anno")
    all_name = f"coco_2017_{name}_stuff_sem_seg_head20"
    DatasetCatalog.register(
        all_name,
        lambda x=image_dir, y=gt_dir: load_sem_seg(
            y, x, gt_ext="png", image_ext="jpg"
    ...
    image_dir = os.path.join(root, "val2017_head200")
    gt_dir = os.path.join(root, "val2017_head200_anno")
    all_name = f"coco_2017_{name}_stuff_sem_seg_head200"
    DatasetCatalog.register(
        all_name,
        lambda x=image_dir, y=gt_dir: load_sem_seg(
            y, x, gt_ext="png", image_ext="jpg"
